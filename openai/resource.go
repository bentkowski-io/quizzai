...
func Example(cfg configer) string {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateChatCompletionStream(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateCompletion(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateCompletionStream(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateTranscription(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateTranscription_captions(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateTranslation(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateImage(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClient_CreateImage_base64(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleClientConfig_clientWithProxy(cfg configer) {
	config := openai.DefaultConfig(cfg.ReadString("OPENAI_API_KEY"))
...
func Example_chatbot(cfg configer) {
	client := openai.NewClient(cfg.ReadString("OPENAI_API_KEY"))
...
func ExampleDefaultAzureConfig(cfg configer) {
